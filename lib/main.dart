...
const url = 'https://in.linkedin.com/in/sasibkarat';
const email = 'sasibkarat@gmail.com';
const phone = '+91 9207 893 078';
      ...
      body: SafeArea(
        child: Column(
          ...
          children: <Widget>[
            CircleAvatar(
              radius: 50,
              backgroundImage: AssetImage('images/DSCN1610.jpg'),
            ),
            Text(
              'Sasib Karat',
              style: TextStyle(
